...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
    ...
    return (
        <div
            ...
            ref={containerRef}
        >
            <div className="max-w-7xl mx-auto pt-32 pb-10 px-4 md:px-8 lg:px-10">
                <h2 className="text-lg md:text-4xl mb-4 text-foreground max-w-4xl font-bold">
                    Strategic Intelligence
                </h2>
                <p className="text-muted-foreground text-sm md:text-base max-w-sm">
                    A coherent journey from data to decision.
                </p>
            </div>
            ...
            <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
                    ...
                    >
                        <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                            <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-background flex items-center justify-center border border-border">
                                <div className="h-4 w-4 rounded-full bg-zinc-900 dark:bg-[#8B4BFF] border border-zinc-900/50 dark:border-[#8B4BFF]/50 p-2 shadow-[0_0_10px_rgba(24,24,27,0.5)] dark:shadow-[0_0_10px_#8B4BFF]" />
                            </div>
                ...
                >
                    <motion.div
                        ...
                        className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-[#8B4BFF] via-purple-500 to-transparent from-[0%] via-[10%] rounded-full"
                    />
                </div>
            </div>
        </div>
